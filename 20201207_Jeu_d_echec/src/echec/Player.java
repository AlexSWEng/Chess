...
//			System.out.println("***DEV:" + choixPiece.possibleMoves+"***");
			demanderCase(b);
			move(b, choixPiece, choixLigne, choixColonne);
			// Tant que le joueur selectionne des cases impossibles, on lui demande de
			// rejouer
...
//		System.out.println(choixPiece.colonne);
	...
	public void move(Board b, Piece p, int ligne, int colonne) {
		p.moved = false;
		// si case est help tu fais rien, moved reste à false donc meme joueur rejoue
